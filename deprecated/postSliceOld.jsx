...
const initialState = [
    ...
    },
    {
        ...
        userId: 2,
        media: {
            image: 'https://i.pinimg.com/736x/b4/0e/dc/b40edc274ad5c3086042adc2ea3e5747.jpg',
            video: '',
        },
        reactions: {
            reply: 0,
    ...
    },
    {
        ...
        userId: 6,
        media: {
            image: 'https://pbs.twimg.com/media/GekVDMkbQAAdGiK?format=jpg&name=medium',
            video: '',
        },
        reactions: {
            reply: 0,
...
const postSliceOld = createSlice({
    name: 'post',
    initialState,
    reducers: {
        addPost: {
        ...
        removeLike(state, action) {
            ...
            if (existingPost) {
                const userIndex =
                    existingPost.reactions.likedBy.indexOf(userId);
                if (userIndex !== -1) {
...
export const { addPost, addLike, removeLike, incrementView } =
    postSliceOld.actions;

export default postSliceOld.reducer;
