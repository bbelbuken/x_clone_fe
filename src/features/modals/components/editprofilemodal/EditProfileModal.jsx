    ...
    return (
        <div>
            ...
            >
                <div
                    ref={modalRef}
                    className="relative z-50 mx-auto flex w-[95%] flex-1 flex-col items-center justify-start overflow-hidden rounded-2xl bg-black max-md:h-165 sm:w-[90%] sm:min-w-[350px] md:mb-11 md:h-[710px] md:w-full md:max-w-[40vw] md:min-w-[600px] lg:h-180 xl:h-220"
                >
