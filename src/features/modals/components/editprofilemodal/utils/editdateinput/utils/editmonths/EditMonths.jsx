...
import { MonthData } from 'features/modals/components/createaccountmodal/formarea/inputs/dateinput/data/monthdata/MonthData';
import { DropDownSVG } from 'components/icons/DropDownSVG';

const EditMonths = ({ month, setMonth }) => {
