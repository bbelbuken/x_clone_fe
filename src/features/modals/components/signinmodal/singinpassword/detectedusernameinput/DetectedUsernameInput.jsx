...
const DetectedUsernameInput = ({ username }) => {
    return (
        <div
            htmlFor="username"
            className="relative mt-[10px] mb-3 flex w-full items-center justify-center rounded-[4px] border-none bg-[#202327] px-2 pt-3 pb-[7px] opacity-50 transition-colors duration-200 ease-in-out lg:h-full lg:flex-1"
        >
