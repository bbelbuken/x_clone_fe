...
const PasswordInput = ({ password, setPassword }) => {
  ...
  return (
    <label
      htmlFor="password"
      className={`relative mt-4 mb-3 flex h-full w-full flex-1 items-center justify-center rounded-[4px] border border-[#333639] px-2 py-3 pt-3 pb-2 ${invalidPass && active ? 'focus-within:border-[#f4212e]' : 'focus-within:border-[#1d9bf0]'}`}
    >
