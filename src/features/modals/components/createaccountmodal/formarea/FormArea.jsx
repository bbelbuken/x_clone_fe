...
const FormArea = () => {
  ...
  return (
    <form className="mt-[5px] flex h-full flex-1 flex-col px-20">
      <label
        htmlFor="name"
        className="relative mt-4 flex h-full w-full flex-1 items-center justify-center rounded-[4px] border border-[#333639] px-2 py-3 pt-3 pb-2 focus-within:border-[#1d9bf0]"
      >
