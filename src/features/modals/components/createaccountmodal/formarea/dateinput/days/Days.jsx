...
const Days = ({ selectedDay, setSelectedDay }) => {
  ...
  return (
    <div
      className={`relative mt-4 mr-3 mb-3 flex h-full flex-shrink-0 grow-3 items-center justify-center rounded-[4px] border px-2 py-3 pt-3 pb-2 ${isFocusedDay ? 'border-[#1d9bf0]' : 'border-[#333639]'} `}
    >
