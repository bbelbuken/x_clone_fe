    ...
    return (
        <>
            {menuItems.map((menu, index) => (
                ...
                >
                    <div
                        className="transition-colors-custom flex h-auto max-w-full items-center justify-start rounded-full py-2 hover:bg-[#e7e9ea1a] sm:p-3"
                    ...
                    >
                        ...
                        <div className="mr-4 ml-5 h-auto max-w-full min-w-0 overflow-hidden leading-tight font-thin tracking-wide break-words whitespace-nowrap text-inherit sm:text-[18px] md:text-xl">
                            <h2
