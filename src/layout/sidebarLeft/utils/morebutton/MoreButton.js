  ...
  return (
    <button className="">
      <div className="flex max-w-full rounded-full p-3 hover:bg-[#8b82754d]">
        ...
        <div className="ml-5 mr-4 min-w-0 max-w-full overflow-hidden whitespace-nowrap break-words text-xl leading-tight text-inherit">
          <span className="break-words text-inherit">More</span>
        </div>
      </div>
    </button>
  );
