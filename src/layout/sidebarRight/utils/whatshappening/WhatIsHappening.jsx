            ...
            <div>
                {Trending.map((item, index) => (
                    <div key={index} className="relative">
                        ...
                        <Popover>
                            <PopoverButton className="absolute top-[6px] right-2 flex h-[34.75px] w-[34.75px] cursor-pointer items-center justify-center rounded-full text-[#71767b] transition-colors hover:bg-[#1d9bf022] hover:text-[#1d9bf0]">
