...
const PremiumSection = () => {
  return (
    <aside className="text=[#e7e9ea] relative flex w-full flex-col items-start gap-[10px] px-4 py-3">
      ...
      <Link className="transition-colors-custom mt-[1px] flex min-h-9 min-w-9 items-center justify-center rounded-full bg-[#f91880] px-4 outline-none">
