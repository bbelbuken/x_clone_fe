    ...
    return (
        <>
            ...
            <div className="mx-auto flex w-full max-w-[1265px] flex-col pt-14 md:flex-row md:pt-0">
                {/* Left Sidebar */}
                <div
                    className={`fixed inset-y-0 left-0 z-40 w-64 transform bg-black transition-transform duration-300 ease-in-out md:relative md:translate-x-0 ${
                        isLeftSidebarOpen
                            ? 'translate-x-0'
                            : '-translate-x-full'
                    }`}
                ...
                <main className="flex flex-1 flex-col md:flex-row md:gap-[30px] md:pl-[19px]">
                    ...
                    {!grok && (
                        <div
                            className={`fixed inset-y-0 right-0 z-40 w-64 transform bg-black transition-transform duration-300 ease-in-out lg:relative lg:translate-x-0 ${
                                isRightSidebarOpen
                                    ? 'translate-x-0'
                                    : 'translate-x-full'
                            }`}
