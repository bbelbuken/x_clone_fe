...
const GrokButton = () => {
    return (
        <div className="group absolute top-[5px] right-[34px] flex h-[34.75px] w-[34.75px] cursor-pointer items-center justify-center rounded-full transition-colors hover:bg-[#1d9bf022]">
            <div className="flex items-center justify-center">
                <svg
                    viewBox="0 0 33 32"
                    aria-hidden="true"
                    fill="#71767b"
                    className="transition-colors group-hover:fill-[#1d9bf0]"
                    width={18.75}
                    height={18.75}
                >
