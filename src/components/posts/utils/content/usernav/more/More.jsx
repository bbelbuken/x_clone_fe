...
const More = ({ account, post, currentAccount, currentAccountReposted }) => {
    return (
        <Popover className={'z-50'}>
            {({ open, close }) => (
                <>
                    <PopoverButton className="absolute top-[5px] right-2 z-50 flex h-[34.75px] w-[34.75px] cursor-pointer items-center justify-center rounded-full text-[#71767b] transition-colors hover:bg-[#1d9bf022] hover:text-[#1d9bf0]">
