        ...
        >
            <Popover>
                ...
                >
                    ...
                    <button className="box-border flex h-full w-auto cursor-pointer items-center justify-center">
                        <div className="flex h-full w-full items-center justify-start overflow-hidden px-[15px] py-[9px] outline-none hover:bg-[#e7e9ea0c]">
                            <svg
                                viewBox="0 0 24 24"
                                width={18.75}
                            ...
                            <div className="mr-3 ml-2 max-w-full min-w-0 overflow-hidden text-[15px] break-words whitespace-nowrap text-inherit">
                                <span className="ml-0.5 font-bold break-words text-inherit">
                                    Quote
                                </span>
                            </div>
