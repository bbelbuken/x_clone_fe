    ...
    return (
        ...
        >
            <Popover>
                ...
                <PopoverPanel
                    className={`box-shadow-morebox pointer-cursor absolute -top-3 right-16 z-50 box-border flex h-auto ${
                        isARepost ? 'w-[163px]' : 'w-[120px]'
                    } flex-col items-center justify-center overflow-hidden rounded-xl bg-black transition-colors`}
                >
                    <button
                        className="box-border flex h-full w-full cursor-pointer items-center justify-start"
                        onClick={handleRepost}
                    >
                        <div className="flex h-full w-full items-center justify-start overflow-hidden px-[15px] py-[12px] outline-none hover:bg-[#e7e9ea0c]">
                            <div className="flex w-full min-w-[130px] items-center">
                                <div className="w-[18.75px] flex-shrink-0">
                                    <svg
                                        viewBox="0 0 24 24"
                                        width={18.75}
                                        height={18.75}
                                ...
                                <span className="ml-3 text-[15px] font-bold whitespace-nowrap">
                                    {isARepost ? 'Undo Repost' : 'Repost'}
                                </span>
                            </div>
                        </div>
                    </button>
                    ...
                    <button className="box-border flex h-full w-full cursor-pointer items-center justify-start">
                        <div className="flex h-full w-full items-center justify-start overflow-hidden px-[15px] py-[10px] outline-none hover:bg-[#e7e9ea0c]">
