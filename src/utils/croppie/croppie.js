...
(function (root, factory) {
    ...
    function _initializeResize() {
        ...
        function mouseDown(ev) {
            ...
            originalY = ev.pageY;
            direction =
                ev.currentTarget.className.indexOf('vertical') !== -1
                    ? 'v'
                    : 'h';
    ...
    function _onZoom(ui) {
        var self = this,
            transform = ui
                ? ui.transform
                : Transform.parse(self.elements.preview),
            vpRect = ui
                ? ui.viewportRect
                : self.elements.viewport.getBoundingClientRect(),
            origin = ui
                ? ui.origin
                : new TransformOrigin(self.elements.preview);
    ...
    function _updateCenterPoint(rotate) {
        var self = this,
            ...
            transform = Transform.parse(
                self.elements.preview.style[CSS_TRANSFORM],
            ),
    ...
    function _updateZoomLimits(initial) {
        ...
        if (!initial && (scale < zoomer.min || scale > zoomer.max)) {
            _setZoomerVal.call(
                self,
                scale < zoomer.min ? zoomer.min : zoomer.max,
            );
        } else if (initial) {
    ...
    function _get() {
        var self = this,
            ...
            heightDiff =
                (vpData.height - self.elements.viewport.offsetHeight) / 2,
